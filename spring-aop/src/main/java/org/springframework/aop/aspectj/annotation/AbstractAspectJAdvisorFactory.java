...
public abstract class AbstractAspectJAdvisorFactory implements AspectJAdvisorFactory {
	...
	protected static AspectJAnnotation<?> findAspectJAnnotationOnMethod(Method method) {
		...
		for (Class<?> clazz : ASPECTJ_ANNOTATION_CLASSES) {
			//找到注解PointCut.class Around.class Before.class After.class AfterReturning.class AfterThrowing.class
			//里的方法，并且把注解里面的信息封装成AspectJAnnotation对象
	...
	protected static class AspectJAnnotation<A extends Annotation> {
		...
		public AspectJAnnotation(A annotation) {
			...
			try {
				//解析注解上面的表达式，如@Around("xx()")
				//@AfterReturning(pointcut="execution(public * com.bao.*.*(..))")
